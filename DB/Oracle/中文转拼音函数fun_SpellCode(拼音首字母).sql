CREATE OR REPLACE FUNCTION FUN_SPELLCODE(PRM_SPELL IN VARCHAR2)
    RETURN VARCHAR2
   /*--------------------------------------------------------------------------
   || ÒµÎñ»·½Ú : ¹«¹²Àà_»ñÈ¡ºº×Ö´®µÄÆ´ÒôÖú¼ÇÂë
   || º¯ÊýÃû³Æ fun_SpellCode
   || ¹¦ÄÜÃèÊö £ºÆ´ÒôÂë×ª»»º¯Êý£¬¸ù¾Ý´«Èë×Ö·û´®£¬²úÉú²»³¬¹ý20ÎªµÄÆ´ÒôÖú¼ÇÂë
   || Ê¹ÓÃ³¡ºÏ £º
   || ²ÎÊýÃèÊö £º±êÊ¶                  Ãû³Æ             ÊäÈëÊä³ö   Êý¾ÝÀàÐÍ
   ||            ---------------------------------------------------------------
   ||            prm_spell            ºº×Ö´®              ÊäÈë     VARCHAR2
   ||
   || ²ÎÊýËµÃ÷ £º±êÊ¶               ÏêÏ¸ËµÃ÷
   ||            ---------------------------------------------------------------
   ||                       
   || ÆäËüËµÃ÷ £º
   || ×÷    Õß £º³ÂÖ¾Óñ
   || Íê³ÉÈÕÆÚ £º2005-04-10
   ||---------------------------------------------------------------------------
   ||                                 ÐÞ¸Ä¼ÇÂ¼
   ||---------------------------------------------------------------------------
   || ÐÞ ¸Ä ÈË £º¡Á¡Á¡Á                        ÐÞ¸ÄÈÕÆÚ £ºYYYY-MM-DD
   || ÐÞ¸ÄÃèÊö £º
   ||-------------------------------------------------------------------------*/
    IS 
